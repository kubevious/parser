...
export KUBEVIOUS_V2_COLLECTOR=http://localhost:4102/api/v1/collect
export KUBEVIOUS_V2_COLLECTOR_AUTH=http://localhost:4505/api/v1/auth/collector/login
export KUBEVIOUS_V2_COLLECTOR_KEY_PATH=$MY_DIR/runtime/auth-data.json
